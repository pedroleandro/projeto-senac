...
class Permission extends AbstractModel
{
    ...
    public function setGroupName(string $groupName): void
    {
        ...
        if (strlen($groupName) < 2) {
            throw new \InvalidArgumentException("O grupo da permissão deve ter pelo menos 2 caracteres.");
        }

        if (strlen($groupName) > 100) {
            throw new \InvalidArgumentException("O grupo da permissão deve ter no máximo 100 caracteres.");
        }
